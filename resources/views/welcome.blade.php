...
به زودی از شبکه نمایش خانگی " name="description">
        ...
        <!-- Wox v1.4 || ex nihilo || June - October 2018 - March 2019 -->
        <!-- style start -->
...
{{--         <div class="navigation-fire navigation-icon-wrapper fadeIn-element">
        ...
        {{-- <nav class="navigation-menu">
            ...
            <div class="navigation-menu-img-wrapper">
                ...
                <div class="navigation-menu-img">
                    ...
                    <div class="menu-img" data-bg="img/menu/menu-3.jpg" data-ref="menu-3"></div>
                    <div class="menu-img" data-bg="img/menu/menu-4.jpg" data-ref="menu-4"></div>
                    <div class="menu-img" data-bg="img/menu/menu-5.jpg" data-ref="menu-5"></div>
                    <div class="menu-img" data-bg="img/menu/menu-6.jpg" data-ref="menu-6"></div>
                    ...
                    <div class="center-block-menu">
                        <div class="navigation-menu-txt">
                            <ul class="menu brackets">
                                ...
                                <li>
                                    <a class="menu-state" data-ref="menu-3" href="#services">Services</a>
                                </li>
                                <li>
                                    <a class="menu-state" data-ref="menu-4" href="#works">Works</a>
                                </li>
                                <li>
                                    <a class="menu-state" data-ref="menu-5" href="#news">News</a>
                                </li>
                                <li class="last">
                                    <a class="menu-state" data-ref="menu-6" href="#contact">Contact</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div id="fullpage">
            ...
            <div class="section" id="section0">
                ...
                <div class="bottom-credits fadeIn-element" style="font-family: 'Iran Yekan'; font-size: 20px;direction: rtl">
                    <a class="link-underline" href="https://www.instagram.com/aghazadeh.series/?hl=en">آقازاده</a> &copy; تمام حقوق مالی و معنوی محفوض می باشد.
                </div><!-- bottom credits end -->
                <!-- social icons start -->
                <div class="social-icons-wrapper fadeIn-element">
                    <ul class="social-icons" >
                        <li class="social-icon">
                            <a class="ion-social-instagram" style="font-size: 40px" href="https://www.instagram.com/aghazadeh.series/?hl=en"></a>
                        </li>
                    </ul>
                    ...
                    <div class="hero-bg">
                        ...
                        <div class="swiper-container swiper-slider-top">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide thumbnail-slider-bg-1 overlay overlay-dark-60"></div>
                                <div class="swiper-slide thumbnail-slider-bg-2 overlay overlay-dark-60"></div>
                                <div class="swiper-slide thumbnail-slider-bg-3 overlay overlay-dark-60"></div>
                                <div class="swiper-slide thumbnail-slider-bg-4 overlay overlay-dark-60"></div>
                                <div class="swiper-slide thumbnail-slider-bg-5 overlay overlay-dark-60"></div>
                                <div class="swiper-slide thumbnail-slider-bg-6 overlay overlay-dark-60"></div>
                                <div class="swiper-slide thumbnail-slider-bg-7 overlay overlay-dark-60"></div>
...
<h2 class="section-heading section-heading-light spacer-line-vertical-light" style="font-family: 'Aviny'">
                                                سریال #آقازاده
                                            </h2>
                                            <p class="about-txt">
                                                طراح، نویسنده و تهیه کننده: حامد عنقا
کارگردان: بهرنگ توفیقی
به زودی از شبکه نمایش خانگی 
                            ...
                            <div class="contact-container element-color-switch contact-reset">
                                ...
                                <div class="center-container">
                                    ...
                                    <div class="center-block">
                                        <p class="contact-txt">
                                            <span class="contact-info-mail"><a class="link-underline link-underline-dark" href="mailto:seriesaghazadeh@gmail.com">seriesaghazadeh@gmail.com</a></span>
                            ...
                            <div class="center-block-contact-modal">
                                ...
                                <div class="row contact-modal-wrapper">
                                    ...
                                    <div class="col-lg-12">
                                        <!-- contact form start -->
                                        <div id="contact-form">
                                            <form action="contact.php.html" id="form" method="post" name="send">
                                                <!-- col start -->
